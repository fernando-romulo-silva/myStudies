...
public class Question06 {
    ...
    // If you require it to remember only until the user is still browsing, then HttpSession is the right answer.
    //
    // Otherwise, ServletContext is the right answer. You can always store this information in the database, if you not consider WEB TIER
    //
