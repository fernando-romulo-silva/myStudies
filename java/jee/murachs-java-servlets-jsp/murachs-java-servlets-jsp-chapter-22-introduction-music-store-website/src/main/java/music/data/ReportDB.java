...
public class ReportDB {
	...
	Statement statement = null;
	ResultSet rs = null;
	String query = "SELECT DownloadDate, " + "   Download.ProductCode, " + "   Email, FirstName, LastName " + "FROM User " + "   INNER JOIN Download ON User.UserID = Download.UserID "
			+ "WHERE DownloadDate >= '" + startDate + "' " + "   AND DownloadDate <= '" + endDate + "' " + "ORDER BY DownloadDate DESC";
