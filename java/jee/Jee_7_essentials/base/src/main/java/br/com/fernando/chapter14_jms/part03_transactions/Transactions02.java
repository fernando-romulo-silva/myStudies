...
import static br.com.fernando.chapter14_jms.part03_transactions.Transactions02.DeliveryStats.countDownLatch;
...
public class Transactions02 {
    ...
    public static class Resources {
        ...
        public static final String CONNECTION_FACTORY_JNDI = "jms/requestQueueFactory";
    }
    ...
    public static void main(final String[] args) throws Exception {
        ...
        try ( //
            ...
            final MyEmbeddedDataSource dataSource = new MyEmbeddedDataSourceBuilder(EMBEDDED_JEE_TEST_DATA_SOURCE_NAME, dataBaseUrl) //
                    ...
                    .withXaTransaction(false) //
                    .build();
            embeddedJeeServer.addDataSource(dataSource);

            final MyEmbeddedJmsConnectionFactory connectionFactory = new MyEmbeddedJmsConnectionFactoryBuilder(Resources.CONNECTION_FACTORY_NAME, JmsType.QUEUE)//
                    .withXaTransaction(false) //
                    .build();
