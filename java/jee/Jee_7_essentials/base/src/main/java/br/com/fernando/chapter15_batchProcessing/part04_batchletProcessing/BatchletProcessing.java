...
public class BatchletProcessing {
    ...
    public static void main(final String[] args) throws Exception {
        ...
        try ( //
            ...
            war.addMetaInfFiles(EmbeddedResource.add("batch-jobs/myJob.xml", "src/main/resources/chapter15_batchProcessing/part04_batchletProcessing/myJob.xml"));

            war.addClasses( //
                    MyBatchlet.class, // 
                    BatchTestHelper.class, ExecuteBatchServlet.class, ExecuteBatchEJB.class //
            );
