...
public class ChunkOrientedProcessing {

    // The chunk-oriented processing style is the primary pattern for batch processing in the specification.
    //
    // It is an item-oriented way of processing where multiple items are read and processed to create “chunks-
    // that are then written out, all within a transaction boundary.
    //
    // Interfaces and classes for chunk-oriented artifacts
    //
    // Reader -> ItemReader -> AbstractItemReader
    //
    // Processor -> ItemProcessor -> None
    //
    // Writer -> ItemWriter -> AbstractItemWriter
    //
    // Job XML is used to define the chunk step:
    // src/main/resources/chapter15_batchProcessing/part01_chunkOrientedProcessing/myJob.xml
    ...
    public static void main(final String[] args) throws Exception {
        ...
        try ( //
            ...
            war.addMetaInfFiles(EmbeddedResource.add("batch-jobs/myJob.xml", "src/main/resources/chapter15_batchProcessing/part01_chunkOrientedProcessing/myJob.xml"));
