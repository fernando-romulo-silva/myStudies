...
public class CustomCheckpointing {
    ...
    // Checkpoints allow a step execution to periodically bookmark its current progress to enable restart from the last point of consistency,
    // following a planned or unplanned interruption.
    // By default, the end of processing for each chunk is a natural point for taking a checkpoint.
    //
    // You can specify a custom checkpoint policy using the checkpoint-policy attribute in Job XML (part02_customCheckpointing/myJob.xml)
    // ==========================================================================================================================================================
    public static void main(final String[] args) throws Exception {
        ...
        try ( //
            ...
            war.addMetaInfFiles(EmbeddedResource.add("batch-jobs/myJob.xml", "src/main/resources/chapter15_batchProcessing/part02_customCheckpointing/myJob.xml"));

            war.addClasses( //
                    MyCheckpointAlgorithm.class, ExecuteBatchServlet.class, ExecuteBatchEJB.class, //
                    BatchTestHelper.class, MyInputRecord.class, MyOutputRecord.class, //
