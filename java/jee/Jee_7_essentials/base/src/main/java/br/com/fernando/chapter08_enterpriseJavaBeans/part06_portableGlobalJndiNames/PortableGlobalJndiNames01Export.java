...
public class PortableGlobalJndiNames01Export {
	...
	propertiesGlassfish.put(INITIAL_CONTEXT_FACTORY, "com.sun.enterprise.naming.SerialInitContextFactory");
	propertiesGlassfish.put(URL_PKG_PREFIXES, "com.sun.enterprise.naming");
	propertiesGlassfish.put(PROVIDER_URL, "localhost:1099");
	...
	propertiesJBoss.put(Context.INITIAL_CONTEXT_FACTORY, "org.jboss.naming.remote.client.InitialContextFactory"); // java.naming.factory.initial
	propertiesJBoss.put(Context.URL_PKG_PREFIXES, "org.jboss.ejb.client.naming"); // java.naming.factory.url.pkgs
	propertiesJBoss.put(Context.PROVIDER_URL, System.getProperty(Context.PROVIDER_URL, "remote://localhost:4447")); // java.naming.provider.url
	propertiesJBoss.put("jboss.naming.client.ejb.context", "true");

	propertiesJBoss.put(Context.SECURITY_PRINCIPAL, System.getProperty("username", "admin")); // java.naming.security.principal
	propertiesJBoss.put(Context.SECURITY_CREDENTIALS, System.getProperty("password", "admin")); // java.naming.security.credentials
