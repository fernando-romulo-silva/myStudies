...
public class Split {
    // A split execution element defines a set of flows that execute concurrently.
    // Look at src/main/resources/chapter15_batchProcessing/part08_split/myJob.xml
    // ==========================================================================================================================================================
    public static void main(final String[] args) throws Exception {
        ...
        try ( //
            ...
            war.addMetaInfFiles(EmbeddedResource.add("batch-jobs/myJob.xml", "src/main/resources/chapter15_batchProcessing/part08_split/myJob.xml"));

            war.addClasses( //
                    ExecuteBatchServlet.class, ExecuteBatchEJB.class, BatchTestHelper.class, //
                    MyBatchlet1.class, MyBatchlet2.class, MyBatchlet3.class);
