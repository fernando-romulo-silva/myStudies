...
<%@ taglib prefix="fmt" uri="http://xmlns.jcp.org/jsp/jstl/fmt" %>
...
<div id="page">
    ...
    <div class="content">
        <h2>
            <spring:message code="detectives.list.title"/>
        </h2>
        ...
        <div class="detectives">
            <table>
                ...
                <tr>
                    <td>
                        <spring:message code="label.Detective.count"/>
                    </td>
                    <td>
                        <spring:message code="label.Detective.name"/>
                    </td>
                    <td>
                        <spring:message code="label.Detective.badgeNumber"/>
                    </td>
                    <td>
                        <spring:message code="label.Detective.rank"/>
                    </td>
                    <td>
                        <spring:message code="label.Detective.status"/>
                    </td>
                </tr>
                </thead>
                <c:forEach var="detective" items="${detectives}">
                    <tr>
                        <td>
                            <spring:url var="showUrl" value="{id}">
                                <spring:param name="id" value="${detective.id}"/>
                            </spring:url>
                            <a href="${showUrl}">${detective.id}</a>
                        </td>
                        <td>
                                ${detective.person.firstName} ${detective.person.lastName}
                        </td>
                        <td>
                                ${detective.badgeNumber}
                        </td>
                        <td>
                                ${detective.rank}
                        </td>
