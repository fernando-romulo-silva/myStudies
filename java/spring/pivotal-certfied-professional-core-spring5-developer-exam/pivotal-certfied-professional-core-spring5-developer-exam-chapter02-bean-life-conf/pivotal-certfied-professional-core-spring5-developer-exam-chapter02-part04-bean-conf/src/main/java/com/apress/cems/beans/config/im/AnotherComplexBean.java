...
SOFTWARE.
*/
package com.apress.cems.beans.config.im;

import org.slf4j.Logger;
import org.slf4j.LoggerFactory;
import org.springframework.beans.factory.annotation.Autowired;

import com.apress.cems.beans.config.lc.AnotherSimpleBean;
import com.apress.cems.beans.config.lc.SimpleBean;
...
public class AnotherComplexBean {
    ...
    /**
     * The initialization method. Just for fun: it instantiates the anotherSimpleBean only if the current time is even.
     */
    void beanInitMethod() {
