...
@ApressService
@Service
public class StorageServiceAopImpl implements StorageService {
    private static final Logger logger = LoggerFactory.getLogger(StorageServiceAopImpl.class);
    private StorageRepo storageRepo;

    public StorageServiceAopImpl(StorageRepo storageRepo) {
