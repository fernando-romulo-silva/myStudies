...
public class EchoHandlerIntegrationTest {
    ...
    private StompSession connectAndSubscribe(CompletableFuture<String> answer) throws InterruptedException, ExecutionException, TimeoutException {

	var uri = "ws://localhost:" + port + "/echo-endpoint";
	var stompSession = stompClient.connect(uri, new StompSessionHandlerAdapter() {
