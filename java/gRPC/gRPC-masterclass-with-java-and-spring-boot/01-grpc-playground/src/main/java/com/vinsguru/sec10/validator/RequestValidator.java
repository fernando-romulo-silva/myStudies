...
public class RequestValidator {
    ...
    private static final Metadata.Key<ErrorMessage> ERROR_MESSAGE_KEY = ProtoUtils
            .keyForProto(ErrorMessage.getDefaultInstance());
    ...
    private static Metadata toMetadata(ValidationCode code) {
        ...
        final var key = Metadata.Key.of("desc", Metadata.ASCII_STRING_MARSHALLER);
