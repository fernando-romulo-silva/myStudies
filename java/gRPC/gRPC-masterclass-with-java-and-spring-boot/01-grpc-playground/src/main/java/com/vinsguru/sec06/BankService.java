...
public class BankService extends BankServiceGrpc.BankServiceImplBase {
    ...
    public void withdraw(WithdrawRequest request, StreamObserver<Money> responseObserver) {
        /*
         * Ideally we should do some input validation. But we are going to assume only
         * happy path scenarios.
         * Because, in gRPC, there are multiple ways to communicate the error message to
         * the client. It has to be discussed in detail separately.
