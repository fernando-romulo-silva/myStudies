...
public class LocalDateTimeScalar implements Coercing<LocalDateTime, String> {
    ...
    @Override
    public LocalDateTime parseValue(final Object input, final GraphQLContext graphQLContext, final Locale locale) throws CoercingParseValueException {
    ...
    @Override
    public LocalDateTime parseLiteral(final Value<?> input, final CoercedVariables variables, final GraphQLContext graphQLContext, final Locale locale) throws CoercingParseLiteralException {
