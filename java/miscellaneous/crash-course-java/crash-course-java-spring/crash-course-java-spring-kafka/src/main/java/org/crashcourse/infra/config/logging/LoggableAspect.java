...
public class LoggableAspect {
     ...
     */
    @Pointcut("@annotation(org.crashcourse.infra.config.logging.Loggable)")
     ...
     */
    @Pointcut("@within(org.crashcourse.infra.config.logging.Loggable)")
	...
	try {
	    ...
	    final var response = ofNullable(point.proceed()).orElse("void");
