...
public interface ListagemLivros {
     ...
     * 
     * @return
     *     returns java.util.List<br.com.fernando.client.Livro>
     */
    @WebMethod
    ...
    @WebMethod
    @WebResult(name = "livro", targetNamespace = "")
    @RequestWrapper(localName = "listarLivrosPaginacao", targetNamespace = "http://application.server.fernando.com.br/", className = "br.com.fernando.client.ListarLivrosPaginacao")
    @ResponseWrapper(localName = "listarLivrosPaginacaoResponse", targetNamespace = "http://application.server.fernando.com.br/", className = "br.com.fernando.client.ListarLivrosPaginacaoResponse")
    @Action(input = "http://application.server.fernando.com.br/ListagemLivros/listarLivrosPaginacaoRequest", output = "http://application.server.fernando.com.br/ListagemLivros/listarLivrosPaginacaoResponse")
