...
// Aqui estamos mapeando os atributos da classe, ou seja, os atributos da classe serao as tags XML.
//
@XmlAccessorType(XmlAccessType.FIELD)
//
// Podemos definir o nome da tag raiz de cada Livro, e seus os atributos
@XmlType(name = "livro", propOrder = { "anoDePublicacao", "autores", "editora", "nome", "resumo" })
public class Livro {

    protected Integer anoDePublicacao;

    // Com 'nillable = true' definimos que
