...
public class LivrosService extends Service {
    ...
    public LivrosService(final WebServiceFeature... features) {
        super(__getWsdlLocation(), LIVROS_QNAME, features);
    }

    public LivrosService(final URL wsdlLocation) {
        super(wsdlLocation, LIVROS_QNAME);
    }

    public LivrosService(final URL wsdlLocation, final WebServiceFeature... features) {
        super(wsdlLocation, LIVROS_QNAME, features);
    }

    public LivrosService(final URL wsdlLocation, final QName serviceName) {
        super(wsdlLocation, serviceName);
    }

    public LivrosService(final URL wsdlLocation, final QName serviceName, final WebServiceFeature... features) {
