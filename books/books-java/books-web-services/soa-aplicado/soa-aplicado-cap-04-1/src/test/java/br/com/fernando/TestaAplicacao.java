...
public class TestaAplicacao {
    ...
    public static void main(final String[] args) {
        ...
        // Iniciando o servidor Jetty
        final EmbeddedJettyServer embeddedJettyServer = new EmbeddedJettyServer();
        embeddedJettyServer.start(httpPort);
        embeddedJettyServer.deploy(appName, war.exportToFile("target").getAbsolutePath());
