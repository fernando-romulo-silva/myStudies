...
public class DateUtil {
     ...
     */
    public static Date parseDate(final String dateValue, final Collection<String> dateFormats) throws DateParseException {
     ...
     *            the date formats to use
     * @param startDate
     *            During parsing, two digit years will be placed in the range <code>startDate</code> to <code>startDate + 100 years</code>. This value may be <code>null</code>. When <code>null</code> is given as a parameter, year <code>2000</code>
     *            will be used.
     * @return the parsed date
     * @throws DateParseException
     *             if none of the dataFormats could parse the dateValue
    ...
    public static Date parseDate(String dateValue, Collection<String> dateFormats, Date startDate) throws DateParseException {
        ...
        final Iterator<String> formatIter = dateFormats.iterator();

        while (formatIter.hasNext()) {
            final String format = formatIter.next();
            if (dateParser == null) {
