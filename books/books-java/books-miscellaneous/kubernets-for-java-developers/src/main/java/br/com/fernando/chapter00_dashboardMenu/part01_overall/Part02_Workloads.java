...
public class Part02_Workloads {
    ...
    // However, the term is often used as a general category for tasks and services you want running on your cluster. 
    // It might be synonymous with microservices, applications, containers, or processes. 
    // Workloads are often long-lived processes, but can also be short-lived on demand or batch jobs.
    //
    ...
    // It’s good to know that ReplicaSets exist and what they do, but you will rarely need to create or manage ReplicaSets directly. 
    // Deployments will manage ReplicaSets for you. 
    // You normally only need to deal with ReplicaSets when troubleshooting unexpected problems.
    //
    //
