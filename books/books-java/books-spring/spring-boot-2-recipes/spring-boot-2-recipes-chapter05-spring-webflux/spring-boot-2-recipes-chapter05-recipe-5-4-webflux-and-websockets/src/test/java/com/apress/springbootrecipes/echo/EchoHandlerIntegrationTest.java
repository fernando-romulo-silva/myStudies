...
public class EchoHandlerIntegrationTest {
	...
	assertThat(testClient.getCloseReason()).hasFieldOrPropertyWithValue("closeCode", CloseReason.CloseCodes.NORMAL_CLOSURE);
	...
	assertThat(testClient.getReceived()).containsExactly("RECEIVED: Hello World!");
	...
	/**
	 * Explicitly start Netty. Else while testing a Tomcat instance would be started.
	 *
	 * @return
	 */
	@Bean
