...
import com.apress.cems.services.CriminalCaseService;
...
public class SimpleCriminalCaseService extends SimpleAbstractService<CriminalCase> implements CriminalCaseService {
    ...
    @Override
    public CriminalCase createCriminalCase(CaseType type, String shortDescription, String detailedDescription, CaseStatus caseStatus, String notes, Set<Evidence> evidenceSet,
