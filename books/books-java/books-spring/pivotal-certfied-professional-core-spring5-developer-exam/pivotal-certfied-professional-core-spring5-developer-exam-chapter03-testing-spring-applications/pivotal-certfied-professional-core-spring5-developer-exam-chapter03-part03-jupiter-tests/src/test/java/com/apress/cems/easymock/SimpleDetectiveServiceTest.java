...
class SimpleDetectiveServiceTest {
	 ...
	 * 
	 * @Override void execute() throws Throwable { assertNotNull(detective); } }, new Executable() {
	 * 
	 * @Override void execute() throws Throwable { assertEquals(detective.getId(), simpleDetective.getId()); } }, new Executable() {
	 * 
	 * @Override void execute() throws Throwable { assertEquals(detective.getBadgeNumber(), simpleDetective.getBadgeNumber()); } } );
	 */
    }
}

/*
 * // To test multiple failures assertAll( () -> assertNotNull(detective), () -> assertEquals(2L, detective.getId()), () -> assertEquals("SH2211", detective.getBadgeNumber() ) );
 */