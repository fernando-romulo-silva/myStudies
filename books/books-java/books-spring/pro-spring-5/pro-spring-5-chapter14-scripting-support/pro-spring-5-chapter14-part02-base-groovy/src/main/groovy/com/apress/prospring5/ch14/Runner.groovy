...
// println singer.firstName + " "+ 39 Receiver class Singer does not define or inherit an implementation of the resolved method 'abstract Object getProperty(java.lang.String)' of interface groovy.lang.GroovyObject.at com.apress.prospring5.ch14.Runner.run(Runner.groovy:14)
