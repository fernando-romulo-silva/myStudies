...
public class PartioningJobMapper {
    ...
    public static void main(final String[] args) throws Exception {
        ...
        try ( //
            ...
            war.addMetaInfFiles(EmbeddedResource.add("batch-jobs/myJob.xml", "src/main/resources/chapter15_batchProcessing/part11_partitioningJobMapper/myJob.xml"));

            war.addClasses( //
                    ExecuteBatchServlet.class, ExecuteBatchEJB.class, BatchTestHelper.class, //
                    MyInputRecord.class, MyOutputRecord.class, MyItemReader.class, MyItemWriter.class, MyItemProcessor.class, // 
                    MyAnalyzer.class, MyCollector.class, MyMapper.class, MyReducer.class);
