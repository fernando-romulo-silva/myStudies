...
public class Flow {
    ...
    // A flow execution element defines a sequence of execution elements that execute together as a unit. 
    // When the flow is finished, it is the entire flow that transitions to the next execution element.
    // Look at src/main/resources/chapter15_batchProcessing/part07_flow/myJob.xml
    //
    // ==========================================================================================================================================================
    public static void main(final String[] args) throws Exception {
        ...
        try ( //
            ...
            war.addMetaInfFiles(EmbeddedResource.add("batch-jobs/myJob.xml", "src/main/resources/chapter15_batchProcessing/part07_flow/myJob.xml"));
            ...
            war.addClasses( //
                    ...
                    MyBatchlet1.class, MyBatchlet2.class);
