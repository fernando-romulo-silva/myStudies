...
public class Security08DenyUncovered {
    ...
    public static void main(String[] args) throws Exception {
        ...
        try (final MyEmbeddedJeeContainer embeddedJeeServer = new MyEmbeddedJeeContainer()) {
            ...
            // web inf files
            war.addWebInfFiles(EmbeddedResource.add("web.xml", "src/main/resources/chapter02_servlet/part07_security/web_Security08DenyUncovered.xml"));
            ...
            final Path realFilePath = Paths.get(Security08DenyUncovered.class.getResource("/chapter02_servlet/part07_security/keyfile").toURI());
            ...
            System.out.println("// --------------------------------------------------------------------------------------------------- ");
            //
            executeRequestHttp(HttpGet.class, url01); // HTTP/1.1 401 Unauthorized
            System.out.println("// --------------------------------------------------------------------------------------------------- ");
            //
            System.out.println("// POST ---------------------------------------------------------------------------------------------- ");
            executeRequestHttp("user01", "changeit", HttpPost.class, url01); // user01 ROLE01 // 403 Access to the requested resource has been denied
            System.out.println("// --------------------------------------------------------------------------------------------------- ");
            //
            System.out.println("// DELETE -------------------------------------------------------------------------------------------- ");
            executeRequestHttp("user01", "changeit", HttpDelete.class, url01); // user01 ROLE01 // 403 Access to the requested resource has been denied
            System.out.println("// --------------------------------------------------------------------------------------------------- ");
            //
            System.out.println("// PUT ----------------------------------------------------------------------------------------------- ");
            executeRequestHttp("user01", "changeit", HttpPut.class, url01); // user01 ROLE01 // 403 Access to the requested resource has been denied
            System.out.println("// --------------------------------------------------------------------------------------------------- ");
            //
            System.out.println("// TRACE --------------------------------------------------------------------------------------------- ");
            executeRequestHttp("user01", "changeit", HttpTrace.class, url01); // user01 ROLE01 // 403 Access to the requested resource has been denied
            System.out.println("// --------------------------------------------------------------------------------------------------- ");
            //
            System.out.println("// OPTIONS ------------------------------------------------------------------------------------------- ");
            executeRequestHttp("user02", "changeit", HttpOptions.class, url01); // user01 ROLE01 // 403 Access to the requested resource has been denied
            System.out.println("// --------------------------------------------------------------------------------------------------- ");
