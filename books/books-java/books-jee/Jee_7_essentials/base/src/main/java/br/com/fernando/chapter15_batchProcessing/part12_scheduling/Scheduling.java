...
public class Scheduling {
    ...
    public static void main(final String[] args) throws Exception {
        ...
        try ( //
            ...
            war.addMetaInfFiles(EmbeddedResource.add("batch-jobs/myJob.xml", "src/main/resources/chapter15_batchProcessing/part12_scheduling/myJob.xml"));

            war.addClasses( //
                    ExecuteBatchServlet.class, ExecuteBatchEJB.class, BatchTestHelper.class, //
                    MyBatchlet.class, MyJob.class, MyManagedScheduledBatch.class, MyManagedScheduledBatchBean.class, //
                    MyStepListener.class, AbstractTimerBatch.class, MyTimerScheduleBean.class);
