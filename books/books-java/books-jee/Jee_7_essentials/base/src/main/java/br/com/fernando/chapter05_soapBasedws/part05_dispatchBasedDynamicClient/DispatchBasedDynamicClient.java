...
public class DispatchBasedDynamicClient {
    ...
    public static void main(String[] args) throws Exception {
        ...
        final QName portQName = new QName("http://newdifferentwebservice.com.br", "NewDifferentPort");
        ...
        final Source result01 = dispatch.invoke(new StreamSource(new StringReader(request)));
        ...
        Future<?> response = dispatch.invokeAsync(new StreamSource(new StringReader(request)), new MyAsyncHandler());
        ...
        dispatch.invokeOneWay(new StreamSource(new StringReader(request)));
