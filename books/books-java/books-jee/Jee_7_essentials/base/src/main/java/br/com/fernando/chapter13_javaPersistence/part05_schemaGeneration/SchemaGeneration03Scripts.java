...
public class SchemaGeneration03Scripts {
	...
	public List<Employee> get() {
	    return em.createQuery("SELECT e FROM SchemaGeneration03Scripts$Employee e", Employee.class).getResultList();
	}
    }
	...
	try (final MyEmbeddedJeeContainer embeddedJeeServer = new MyEmbeddedJeeContainer(); //
	    ...
	    war.addMetaInfFiles(EmbeddedResource.add("persistence.xml", "src/main/resources/chapter13_javaPersistence/part05_schemaGeneration/SchemaGeneration03Scripts-persistence.xml"));
	    war.addMetaInfFiles(EmbeddedResource.add("load.sql", "src/main/resources/chapter13_javaPersistence/part05_schemaGeneration/SchemaGeneration03Scripts-load.sql"));
	    war.addMetaInfFiles(EmbeddedResource.add("create.sql", "src/main/resources/chapter13_javaPersistence/part05_schemaGeneration/SchemaGeneration03Scripts-create.sql"));
	    war.addMetaInfFiles(EmbeddedResource.add("drop.sql", "src/main/resources/chapter13_javaPersistence/part05_schemaGeneration/SchemaGeneration03Scripts-drop.sql"));
