package br.com.fernando.myExamCloud.freePracticeTest.ImplementRestServicesJaxRsAPI;
...
public class Question01 {
    ...
    // Choice C is correct
    //
    // JAX-RS and CDI have slightly different component models. By default, JAX-RS root resource classes are managed in the request scope, 
    // and no annotations are required for specifying the scope.
    // 
