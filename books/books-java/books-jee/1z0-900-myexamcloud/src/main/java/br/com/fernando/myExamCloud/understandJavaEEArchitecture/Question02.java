...
public class Question02 {
    ...
    //
    // Choice B - JavaServer Faces
    //
    // Choice C - JavaServer Pages
    //
    // Choice D - CDI Beans
    //
    //
    ...
    // features that help to knit together the web tier and the transactional tier of the Java EE platform.CDI is a set of services that,
    // used together, make it easy for developers to use enterprise beans along with JavaServer Faces technology in web applications.
}
