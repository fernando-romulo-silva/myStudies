...
public class Question04 {
    ...
    //
    // If an error-page element in the deployment descriptor does not contain an exception-type
    // or an error-code element, the error page is a default error page.
    //
