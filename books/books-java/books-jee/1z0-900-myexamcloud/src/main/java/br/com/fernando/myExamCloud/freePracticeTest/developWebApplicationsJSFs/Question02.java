package br.com.fernando.myExamCloud.freePracticeTest.developWebApplicationsJSFs;
...
public class Question02 {
    ...
    // specified in the from-action element is compared to the from-outcome value. Here it is static navigation where we just need to call next page.
    //
    // For this static navigation, this is the navigation from-outcome value i.e. examBoatSearch that will map to search.xhtml in the navigation rule.
}
